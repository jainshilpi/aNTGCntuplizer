...
process.GlobalTag = GlobalTag(process.GlobalTag, '102X_dataRun2_Sep2018Rereco_v1', '') ###ABC
#process.GlobalTag = GlobalTag(process.GlobalTag, '102X_dataRun2_Prompt_v11', '')  ###D
process.maxEvents = cms.untracked.PSet( input = cms.untracked.int32(options.maxEvents) )
process.MessageLogger.cerr.FwkReport.reportEvery = 100
process.source = cms.Source("PoolSource",
                            #fileNames = cms.untracked.vstring(options.inputFiles)
                            fileNames = cms.untracked.vstring(
                                '/store/data/Run2018C/EGamma/MINIAOD/17Sep2018-v1/70000/D5D86301-943A-F348-8399-C7E3154D3135.root'
                            )
                            )

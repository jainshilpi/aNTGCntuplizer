...
process.lostTracksForTkIso = cms.EDProducer("PATLostTracks",
    covarianceSchema = cms.int32(0),
    covarianceVersion = cms.int32(0),
    inputCandidates = cms.InputTag("particleFlow"),
    inputTracks = cms.InputTag("generalTracks"),
    ...
    minPtToStoreProps = cms.double(0.95),
    originalVertices = cms.InputTag("offlinePrimaryVertices"),
    packedPFCandidates = cms.InputTag("packedCandsForTkIso"),
    primaryVertices = cms.InputTag("offlineSlimmedPrimaryVertices"),
    qualsToAutoAccept = cms.vstring('highPurity'),
    secondaryVertices = cms.InputTag("inclusiveSecondaryVertices")
)
...
process.packedCandsForTkIso = cms.EDProducer("PATPackedCandidateProducer",
...
process.ggNtuplizer = cms.EDAnalyzer("ggNtuplizer",
    ...
    ak4PFJetsPUPPISrc = cms.InputTag(""),
...
process.egmGsfElectronIDSequence = cms.Sequence(cms.Task(process.heepIDVarValueMaps, process.lostTracksForTkIso, process.offlineSlimmedPrimaryVertices, process.packedCandsForTkIso, process.primaryVertexAssociation), process.egmGsfElectronIDTask)
...
process.p = cms.Path(process.patDefaultSequence+process.egammaPostRecoSeq+process.ggNtuplizer)
